...
from misc2 import Timer, LatLongDistance
from queues2 import FIFO, LIFO, PriorityQueue
...
def Astar(num_nodes, mission, f_next, heuristic, num_controls):
    """Astar planner."""
    t = Timer()
    t.tic()
    unvis_node = -1
    ...
    goalNode = mission['goal']['id']
    q = PriorityQueue()
    q.insert(0+ heuristic(startNode,goalNode),startNode)
    foundPlan = False
...
def BestFirst(num_nodes, mission, f_next, heuristic, num_controls):
    """BestFirst planner."""
    t = Timer()
    t.tic()
    unvis_node = -1
    ...
    goalNode = mission['goal']['id']
    q = PriorityQueue()
    q.insert(heuristic(startNode,goalNode),startNode)
    foundPlan = False
